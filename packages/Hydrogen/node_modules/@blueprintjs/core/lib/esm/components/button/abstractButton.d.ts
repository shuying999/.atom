...
import { AbstractPureComponent2, Alignment, IActionProps, IRef, IRefObject, MaybeElement } from "../../common";
...
export declare abstract class AbstractButton<H extends React.HTMLAttributes<HTMLElement>> extends AbstractPureComponent2<IButtonProps & H, IButtonState> {
    ...
    protected getCommonButtonProps(): {
        className: string;
        disabled: (IButtonProps & H)["disabled"] | (IButtonProps & H)["loading"];
        onBlur: (e: React.FocusEvent<any>) => void;
        onClick: (IButtonProps & H)["onClick"];
        onKeyDown: (e: React.KeyboardEvent<any>) => void;
        onKeyUp: (e: React.KeyboardEvent<any>) => void;
        tabIndex: number | (IButtonProps & H)["tabIndex"];
    };
